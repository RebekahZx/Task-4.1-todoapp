...
public class AddNewTask extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        editTitle = view.findViewById(R.id.editText_title);
        editDescription = view.findViewById(R.id.editText_description);
        editDueDate = view.findViewById(R.id.editText_dueDate);
        ...
        TextWatcher textWatcher = new TextWatcher() {
            ...
            @Override
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                boolean isTitleEmpty = editTitle.getText().toString().trim().isEmpty();
                saveButton.setEnabled(!isTitleEmpty);
                saveButton.setBackgroundColor(isTitleEmpty ? Color.GRAY : getResources().getColor(R.color.colorPrimary));
            }
        };
